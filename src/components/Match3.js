...
export default class Match3 extends Component {
  ...
  openUpdate = (post) => {
    ...
    document.getElementById("clustersML").value = this.selected.clusterRegion;
  }
          ...
          posts.matches.slice(0,searchML).map(post =>
            <div className={styles.rowButtonWrapper}>
              <div className={styles.tableRow}>
                ...
                <div className={`${styles.mainColumn} ${Matchstyles.mlColumnTwo}`}>
                  {post.id}
                </div>
                <div className={Matchstyles.mlColumnThree}>
                  {post.proportion}
                </div>
                <div className={Matchstyles.mlColumnFour}>
                  {post.likes}
                </div>
